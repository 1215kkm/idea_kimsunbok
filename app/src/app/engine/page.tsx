...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    icon: "🔗",
    detail: "a:500,000,000(free) 이탈모드 자유값에서:\n\n- b:80,000,000 → A1 자유값 (8% = 0.8%×10회)\n  남은: 420,000,000\n- c:120,000,000 → 소비자적립 (12%)\n  남은: 300,000,000\n- d:50,000,000 → 보정값 (5%)\n  남은: 250,000,000\n- e:50,000,000 → 광고주적립 (5%)\n= f:200,000,000 → 수수료 (20%)\n\n합계: 80+120+50+50+200 = 500M ✓\n검증식: 8+12+5+5+20 = 50% ✓",
    highlight: "a→f",
  },
  {
    title: "단계별 적립모드 (4~7단계)",
    desc: "회원 자금에 따라 자동 분류 — 순차 적립",
    icon: "🪜",
    detail: "회원 잔액에 따라 단계 자동 결정:\n4단계(백만) · 5단계(천만) · 6단계(1억) · 7단계(10억)\n\n예) 7단계 (10억 단위):\nA1:[a1:1억 × 10개] = 10억\n순차적으로 A1:[a1~a10] × 10개 적립\n\n소비자단계 (6단계 예):\nA1:[a1:100,000,000(1억)]:빈로그\n× 120%(free) = 120,000,000 재충전\n× 10회 = 12억 적립\n\n분할모드: 10억P까지 자동,\n초과 대량 거래는 관리자 수동 전환",
    highlight: "4~7단계",
  },
  {
    title: "광고주 적립 (5%)",
  ...
  {
    title: "최종 결과 → 다랜드 내 계좌에 적립 (AI코드)",
    desc: "10,000원 결제 → 12,000P 다랜드 계좌 적립!",
    icon: "🎉",
    detail: "『AI코드』 — 지출 차감 후 120% 재충전 모드\n(마이데이터법 기반, AI 데이터에 의한 기본소득)\n\n원금: 10,000P\n보너스: 2,000P (+20% 증액)\n\n합계: 12,000P (120% 적립!)\n\n✅ 다랜드 내 계좌에 12,000P 적립\n✅ 등록된 은행계좌로 출금 가능 (1P = 1원)\n✅ 광고주에게 5% 적립 (500P)\n✅ 데이터에 의한 기본소득 창출\n✅ 모두가 사용자 — 가맹점 구분 없음",
    highlight: "12,000P",
  },
];
