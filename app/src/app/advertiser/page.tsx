      ...
      <div className="mx-auto max-w-lg px-5 py-6">
        ...
        {showResult && (
          <div className="space-y-3">
            ...
            >
              <div className="mb-3 text-xs font-bold text-purple-400">
                비선형공식 분배 과정
              </div>
            ...
            >
              ...
              <div className="mt-1 inline-block rounded-full bg-gradient-to-r from-emerald-500 to-cyan-400 px-4 py-1 text-sm font-bold text-white">
                120% 수익 달성!
              </div>
            ...
            >
              ...
              <p>
                기존 광고: 광고비 → 노출 → 끝 (돈이 사라짐)
              </p>
              <p className="mt-2">
                다랜드 광고: 광고비 → 비선형 시스템 충전 → 소비자에게 분배 →
                소비자가 가맹점에서 결제 → 가맹점 적립 → 다시 순환
              </p>
              <p className="mt-2 text-center font-bold text-emerald-400">
                광고비가 사라지지 않고, 120%로 돌아옵니다.
              </p>
            </div>
          </div>
        )}
