...
const SECTIONS = [
  ...
  {
    title: "데이터노동 (Data Labor)",
    subtitle: "지출(분배)해도 항상 120%가 돌아온다",
    content:
      "광고주가 리워드 광고로 회원에게 분배해도\n비선형공식에 의해 항상 120%가 돌아옵니다.\n100% 분배원금 + 20% 수익\n\n회원이 돈이 필요하면 언제라도\n리워드 광고를 통해 수익을 낼 수 있습니다.\n\n이것이 데이터노동입니다.",
    icon: "🌱",
    color: "#22c55e",
  },
  {
    ...
    content:
      "한 사람의 소비가 사라지지 않고\n다른 멤버십 회원에게 전달되고,\n그 회원의 소비가 다시 돌아옵니다.\n\n이 땅에 더 이상 돈이 없어 고통받는 사람이 없고,\n병원비가 없어 치료받지 못하는 사람이 없게 — \n다랜드의 비전입니다.",
    icon: "💫",
    color: "#ec4899",
  },
];
