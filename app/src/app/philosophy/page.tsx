...
const SECTIONS = [
  ...
  },
  {
    ...
    content:
      "소비자는 비선형카드로 결제하면\n결제 금액의 120%를 포인트로 돌려받습니다.\n\n10,000원 결제 → 12,000P 적립\n\n쓸수록 손해가 아니라, 쓸수록 쌓입니다.",
    icon: "👩",
    color: "#06b6d4",
  },
  {
    title: "판매자가 이롭다",
    subtitle: "손님의 결제가 곧 나의 적립",
    content:
      "가맹점 사장님은 손님이 결제할 때마다\n결제 금액의 50%가 판매자 포인트로 적립됩니다.\n\n손님이 많아질수록 사장님도 부자가 됩니다.\n마케팅 비용 없이 단골이 늘어납니다.",
    icon: "🏪",
    color: "#f59e0b",
  },
  {
  ...
  return (
    <div className="min-h-screen pb-20">
      ...
      <div className="mx-auto max-w-lg px-5 py-6">
        {/* 3자 순환 다이어그램 */}
        <div
          className="mb-6 rounded-2xl border border-purple-500/20 p-6"
          style={{
            background:
              "linear-gradient(135deg, rgba(168, 85, 247, 0.05), rgba(6, 182, 212, 0.05))",
          }}
        >
          <div className="mb-4 text-center text-sm font-bold text-purple-400">
            3자 순환 구조
          </div>
          ...
          <div className="relative mx-auto" style={{ width: 260, height: 240 }}>
            {/* 중심 */}
            <div
              className="absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-full text-center"
              style={{
            ...
            <div className="absolute left-1/2 top-0 flex -translate-x-1/2 flex-col items-center">
              ...
              <div className="mt-1 text-xs font-bold">소비자</div>
            ...
            <div className="absolute bottom-0 left-0 flex flex-col items-center">
              ...
              <div className="mt-1 text-xs font-bold">판매자</div>
              <div className="text-[0.6rem] text-amber-400">50% 적립</div>
            </div>
          ...
          <p className="mt-4 text-center text-xs text-zinc-500">
            소비자의 결제 → 판매자 적립 → 광고주 투자 → 다시 소비자에게
          </p>
        </div>
        ...
        <div className="mb-4 flex gap-2 overflow-x-auto pb-1">
          {SECTIONS.map((s, i) => (
            <button
              ...
              style={{
                background:
                  i === activeSection ? s.color + "33" : "rgba(255,255,255,0.05)",
        ...
        >
          ...
          <div className="mt-4 whitespace-pre-line text-sm leading-relaxed text-zinc-300">
        ...
        {/* 핵심 명언 */}
        <div
          className="mt-6 rounded-2xl border border-purple-500/20 p-5 text-center"
          style={{
            background:
        ...
        >
          ...
          <p className="mt-2 text-base font-bold italic text-purple-300">
            &ldquo;자리이타 이타자리&rdquo;
          </p>
          <p className="mt-1 text-xs text-zinc-500">
            스스로 이롭고 남도 이롭게 — 남이 이로우면 나도 이롭다
          </p>
          ...
          <p className="mt-1 text-xs text-zinc-500">
            돈이 새로 생기는 것이 아니라, 순환하여 모두에게 돌아가는 구조
          </p>
        </div>
      </div>
