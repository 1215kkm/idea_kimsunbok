    ...
    <div className="min-h-screen pb-20">
      ...
      <div className="mx-auto max-w-lg px-5 py-6">
        ...
        <div className="mb-6 flex justify-center" style={{ perspective: 1000 }}>
          <div onClick={() => setIsFlipped(!isFlipped)} className="relative cursor-pointer"
            style={{ width: 320, height: 200, transformStyle: "preserve-3d", transition: "transform 0.6s", transform: isFlipped ? "rotateY(180deg)" : "rotateY(0)" }}>
            ...
            {[
              ...
              <div key={i} className="flex items-start gap-3">
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-xs font-black text-white"
                  style={{ background: i === 3 ? "linear-gradient(135deg, #10b981, #06b6d4)" : "linear-gradient(135deg, #a855f7, #06b6d4)" }}>
                  {s.step}
                </div>
                <div>
