...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: "/advertiser", label: "광고주", icon: "business", desc: "리워드 캠페인으로 회원 유치", admin: false },
  { href: "/advertiser/invite", label: "리워드 초대", icon: "card_giftcard", desc: "내 예산으로 회원 초대", admin: false },
